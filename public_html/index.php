...
<html>
	...
	<body>
        ...
        <section id="footer">
			...
			<div class="copyright">
				<ul class="menu">
					<li>&copy; Develop <a href="https://www.facebook.com/profile.php?id=100007217865952" target="_blank">Rishat Sultanov.</a></li><li>Open Source: <a href="https://github.com/Rishats" target="_blank">GitHub</a></li>
				</ul>
			</div>
		</section>
